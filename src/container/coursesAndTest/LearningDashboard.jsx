  ...
  return (
    <>
      ...
      <div className="flex bg-gray-100 min-h-screen">
        {/* Sidebar */}
        <div className="w-32 bg-white shadow-md flex flex-col items-center py-6 space-y-4 p-1">
          <FaBell className="text-xl text-gray-600 cursor-pointer hover:text-yellow-500" />
